...
<html lang="en-us">
  <head>
    ...
    <title>Unity WebGL Player | Identifier</title>
  ...
  <body>
    <div id="unity-container" class="unity-desktop">
      ...
      <div id="unity-footer">
        ...
        <div id="unity-build-title">Identifier</div>
      </div>
    </div>
...
.footer__bottom {
  ...
  <script>
      ...
      var buildUrl = "Build";
      var loaderUrl = buildUrl + "/Guess the element Web build.loader.js";
      var config = {
        dataUrl: buildUrl + "/Guess the element Web build.data",
        frameworkUrl: buildUrl + "/Guess the element Web build.framework.js",
        codeUrl: buildUrl + "/Guess the element Web build.wasm",
