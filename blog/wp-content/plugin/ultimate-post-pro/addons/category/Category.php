...
class Category{
    ...
    public function save_taxonomy_image( $term_id, $tt_id ) {
        if( isset( $_POST['ultp_category_image'] ) && '' !== $_POST['ultp_category_image'] ){
            add_term_meta( $term_id, 'ultp_category_image', absint( $_POST['ultp_category_image'] ), true );
        }
        if( isset( $_POST['ultp_category_color'] ) && '' !== $_POST['ultp_category_color'] ){
            add_term_meta( $term_id, 'ultp_category_color', esc_attr($_POST['ultp_category_color']), true );
        }
    }
    ...
    public function updated_taxonomy_image( $term_id, $tt_id ) {
        ...
        if( isset($_POST['ultp_category_image']) ){
            update_term_meta( $term_id, 'ultp_category_image', absint( $_POST['ultp_category_image'] ) );
        }
        if( isset( $_POST['ultp_category_color'] ) ){
            update_term_meta( $term_id, 'ultp_category_color', esc_attr($_POST['ultp_category_color']) );
        }
    }
