        ...
        if ($header_id) {
            ...
            ?> 
                <header id="ultp-header-template">
                    <?php echo ultimate_post()->content($header_id) ?>
                </header> 
            <?php
        }
	}
        ...
        if ($footer_id) {
            ...
            ?> 
                <footer id="ultp-footer-template" role="contentinfo">
                    <?php echo ultimate_post()->content($footer_id) ?>
                </footer> 
            <?php
        }
	}
    ...
    function video_source_callback($post) {
        ...
        <div class="ultp-meta-video">
            <?php if(current_user_can('administrator')) { ?>
                <a class="ultp-dash-builder-btn" target="_blank" href="<?php echo esc_url(admin_url('admin.php?page=ultp-settings#builder')); ?>"><?php _e('Enable PostX Single Builder', 'ultimate-post'); ?> </a>
            <?php } ?>
            <label><?php _e('Featured Video', 'ultimate-post'); ?></label>
            ...
            <span><strong><?php _e('Note: ', 'ultimate-post'); ?></strong><?php _e('Enter Youtube/ Vimeo/ Self Hosted URL', 'ultimate-post'); ?></span>
            <label><?php _e('Featured Video Caption', 'ultimate-post'); ?></label>
