function createUnityInstance(e, r, n) {
    ...
    document.addEventListener("webkitfullscreenchange", function(r) {
        ...
        n === e ? e.style.width && (h = e.style.width, p = e.style.height, e.style.width = "100%", e.style.height = "100%") : h && (e.style.width = h, e.style.height = p, h = "", p = "")
    });
    var b = {
        Module: c,
    ...
    return c.SystemInfo = function() {
        ...
        c.SystemInfo.hasWebGL ? c.SystemInfo.hasWasm ? (1 == c.SystemInfo.hasWebGL && c.print('Warning: Your browser does not support "WebGL 2.0" Graphics API, switching to "WebGL 1.0"'), c.startupErrorHandler = r, n(0), c.postRun.push(function() {
