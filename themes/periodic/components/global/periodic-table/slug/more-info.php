...
<div class="element-slug-info">
    <div class="element-slug-info__wrapper container">
        ...
        <div class="single-inline-button">
            <div class="element-slug-info__top" >
                <span id="expand" style="text-align: right;" data-color="<?php echo $payload->element->main_info->element_type->color; ?>">expand all +</span>
            </div>
             <div class="element-slug-info__top">
                <span id="collapse" style="text-align: right;" data-color="<?php echo $payload->element->main_info->element_type->color; ?>">collapse all -</span>
            </div>
        </div>
        <div class="element-slug-info__bottom">
            ...
            <?php if ($payload->element->atomic_data->atomic_radius_non_bonded): ?>
                <div id="atomic-data" class="element-slug-info__collapse" style="border: 2px solid <?= $payload->element->main_info->element_type->color; ?>;">
                    ...
                    <div class="element-slug-info__collapse-bottom">
                        <div class="element-slug-info__collapse-desc element-slug-info__collapse-desc--inline row">
                            <div class="element-slug-info__collapse-col col-12 col-sm-3"><b>Atomic Radiues, Non-bonded (A):</b> <span><?= $payload->element->atomic_data->atomic_radius_non_bonded; ?></span></div>
                            <div class="element-slug-info__collapse-col col-12 col-sm-3"><b>Electron Affinity (kJ mol-1):</b> <span><?= $payload->element->atomic_data->electron_affinity; ?></span></div>
                            <div class="element-slug-info__collapse-col col-12 col-sm-3"><b>Covalent Radiues (A):</b> <span><?= $payload->element->atomic_data->covalent_radius; ?></span></div>
                            <div class="element-slug-info__collapse-col col-12 col-sm-3"><b>Electronegativity (Pauling Scale):</b> <span><?= $payload->element->atomic_data->electronegativity; ?></span></div>
            ...
            <?php if ($payload->element->supply_risk->relative_supply_risk): ?>
                <div id="supply" class="element-slug-info__collapse" style="border: 2px solid <?= $payload->element->main_info->element_type->color; ?>;">
                    ...
                    <div class="element-slug-info__collapse-bottom">
                        <div class="element-slug-info__collapse-desc element-slug-info__collapse-desc--inline row">
                            <div class="element-slug-info__collapse-col col-12 col-md-4"><b>Relative Supply Risk:</b> <span><?= $payload->element->supply_risk->relative_supply_risk; ?></span></div>
                            <div class="element-slug-info__collapse-col col-12 col-md-4"><b>Crustal Abundance (ppm):</b> <span><?= $payload->element->supply_risk->crustal_abundance; ?></span></div>
                            <div class="element-slug-info__collapse-col col-12 col-md-4"><b>Recycle Rate (%):</b> <span><?= $payload->element->supply_risk->recycling_rate; ?></span></div>

                            <div class="element-slug-info__collapse-col"><b> </b> <span> </span></div>

                            <div class="element-slug-info__collapse-col col-12 col-md-4"><b>Production Conc.(%) :</b> <span><?= $payload->element->supply_risk->production_concentration; ?></span></div>
                            <div class="element-slug-info__collapse-col col-12 col-md-4"><b>Top 3 Producers:</b><br><span><?= nl2br($payload->element->supply_risk->top_3_producers); ?></span></div>
                            <div class="element-slug-info__collapse-col col-12 col-md-4"><b>Top 3 Reserve Holders:</b><br> <span><?= nl2br($payload->element->supply_risk->top_3_reserve_holders); ?></span></div>

                            <div class="element-slug-info__collapse-col"><b> </b> <span> </span></div>

                            <div class="element-slug-info__collapse-col col-12 col-md-4"><b>Substitutability:</b> <span><?= $payload->element->supply_risk->substitutability; ?></span></div>
                            <div class="element-slug-info__collapse-col col-12 col-md-4"><b>Political Stability of Top Producer:</b> <span><?= $payload->element->supply_risk->political_stability_of_top_producer; ?></span></div>
                            <div class="element-slug-info__collapse-col col-12 col-md-4"><b>Political Stability of Top Reserve Holder:</b> <span><?= $payload->element->supply_risk->political_stability_of_top_reserve_holder; ?></span></div>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
            <?php if ($payload->element->pressure_and_temperature_data->specific_heat_capacity): ?>
                <div id="pressure" class="element-slug-info__collapse" style="border: 2px solid <?= $payload->element->main_info->element_type->color; ?>;">
                    ...
                    <div class="element-slug-info__collapse-bottom">
                        <div class="element-slug-info__collapse-desc element-slug-info__collapse-desc--inline row">
                            <div class="element-slug-info__collapse-col col-12 col-sm-3"><b>Specific Heat Capacity:</b> <span><?= $payload->element->pressure_and_temperature_data->specific_heat_capacity; ?></span></div>
                            <div class="element-slug-info__collapse-col col-12 col-sm-3"><b>Shear Modulus:</b> <span><?= $payload->element->pressure_and_temperature_data->shear_modulus; ?></span></div>
                            <div class="element-slug-info__collapse-col col-12 col-sm-3"><b>Young Modulus:</b> <span><?= $payload->element->pressure_and_temperature_data->youngs_modulus; ?></span></div>
                            <div class="element-slug-info__collapse-col col-12 col-sm-3"><b>Bulk Modulus:</b> <span><?= $payload->element->pressure_and_temperature_data->bulk_modulus; ?></span></div>
                            <div class="table-responsive col-md-12">
                                <table class="table table-striped w-full">
                        ...
                        <div class="element-slug-info__collapse-desc" style="margin-left: 27%;">
                          <div style="text-align: right;margin-bottom: 15px;display:none">
                           ...
                           <div style="color: black;float:left;height:50px;padding-top: 20px;">
                            ...
                            <div class="placeholder" id="iframePlaceholder" onclick="loadIframe()"></div>
            ...
            <div id="explore_other" class="element-slug-info__collapse" style="border: 2px solid <?= $payload->element->main_info->element_type->color; ?>;">
                <div class="element-slug-info__collapse-top" style="background-color: <?= $payload->element->main_info->element_type->color; ?>;">
                    <div class="element-slug-info__collapse-title"><span style="font-size: 22px;">Explore other Chemical Elements</span></div>
                    <div class="element-slug-info__collapse-action pointer"></div>
                </div>
                <div class="element-slug-info__collapse-bottom">
                  <div class="element-slug-info__collapse-desc element-slug-info__collapse-desc--inline">
                      <?php foreach ($payload->others as $key => $other): ?>
                          <a href="/elements<?= $other->permalink; ?>" class="element-slug-info__collapse-col element-slug-info__collapse-col--link" style="color: <?= $payload->element->main_info->element_type->color; ?>;"><?= $other->title; ?></a>
                      <?php endforeach; ?>
                  </div>
                </div>
            </div>
...
<script>
        function loadIframe() {
            ...
            iframe.src = '<?= $payload->element->video; ?>';
            iframe.width = '100%';
            iframe.height = '750px';
            ...
            iframePlaceholder.parentNode.replaceChild(iframe, iframePlaceholder);
        }
    </script>